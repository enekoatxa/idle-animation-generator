...
class lstmDataset(keras.utils.PyDataset):
    def __init__(self, root, datasetName = "silenceDataset3sec", partition = "Validation", isTiny = False, specificSize = -1, trim = False, sequenceSize = -1, verbose = False, specificTrim = -1, batchSize = 56, onlyPositions = False, onlyRotations = False, outSequenceSize=1, removeHandsAndFace = False, scaler = None, **kwargs):
        ...
        x, ids = bvhLoader.loadDataset(datasetName=datasetName, partition=partition, specificSize=specificSize, trim=trim,
                                                    verbose=verbose, specificTrim=specificTrim, onlyPositions=onlyPositions,
                                                    onlyRotations=onlyRotations, removeHandsAndFace=removeHandsAndFace, scaler=scaler)
